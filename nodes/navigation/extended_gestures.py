...
class GestureSpeed(Enum):
    ...
    SLOW = 2.0  # Languid, thoughtful, melancholic, brooding (2x pauses)
    MED = 1.0   # Normal, default (1x pauses)
    FAST = 0.5  # Zippy, excited, playful, nervous (0.5x pauses)
...
def inspect_floor(car, speed='med'):
    try:
        ...
        car.set_cam_tilt_angle(15, smooth=True)
        car.set_dir_servo_angle(0, smooth=True)
        _sleep(0.33999999999999997, speed)
