...
# look_up – Tilts camera up for better view.
...
def look_up(car):
    """Look up for better camera view - simplified from look_up_then_down"""
    try:
        car.set_cam_pan_angle(0, smooth=True)
        car.set_cam_tilt_angle(30, smooth=True)  # Positive = UP, Negative = DOWN
        car.set_dir_servo_angle(0, smooth=True)
        time.sleep(0.5)
